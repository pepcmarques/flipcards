# Generated by Django 3.2.8 on 2021-10-07 00:50

from django.db import migrations, models
import django.utils.timezone
import flipcards.accounts.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(
                    blank=True, help_text='The groups this user belongs to. A user will get all permissions granted '
                                          'to each of their groups.', related_name='user_set',
            ...
            managers=[
                ('objects', flipcards.accounts.models.UserManager()),
            ],
        ),
    ]
